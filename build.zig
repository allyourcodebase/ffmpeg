...
pub fn build(b: *std.Build) void {
    ...
    const common_config = .{
        ...
        .HAVE_ARM_CRC = have_arm_feat(t, .crc) or have_aarch64_feat(t, .crc),
        ...
        .HAVE_SETEND = false,
        .HAVE_SVE = have_aarch64_feat(t, .sve),
        .HAVE_SVE2 = have_aarch64_feat(t, .sve2),
        .HAVE_SME = have_aarch64_feat(t, .sme),
        .HAVE_SME_I16I64 = have_aarch64_feat(t, .sme_i16i64),
        .HAVE_SME2 = have_aarch64_feat(t, .sme2),
        ...
        .HAVE_RV = false,
        .HAVE_RVV = false,
        .HAVE_RV_ZICBOP = false,
        .HAVE_RV_ZVBB = false,
        .HAVE_SIMD128 = have_wasm_feat(t, .simd128),
        ...
        .HAVE_ARM_CRC_EXTERNAL = have_arm_feat(t, .crc) or have_aarch64_feat(t, .crc),
        ...
        .HAVE_SVE_EXTERNAL = have_aarch64_feat(t, .sve),
        .HAVE_SVE2_EXTERNAL = have_aarch64_feat(t, .sve2),
        .HAVE_SME_EXTERNAL = have_aarch64_feat(t, .sme),
        .HAVE_SME_I16I64_EXTERNAL = have_aarch64_feat(t, .sme_i16i64),
        .HAVE_SME2_EXTERNAL = have_aarch64_feat(t, .sme2),
        ...
        .HAVE_VEC_XL_EXTERNAL = false,
        .HAVE_VSX_EXTERNAL = have_ppc_feat(t, .vsx),
        .HAVE_RV_EXTERNAL = false,
        .HAVE_RVV_EXTERNAL = false,
        .HAVE_RV_ZICBOP_EXTERNAL = false,
        .HAVE_RV_ZVBB_EXTERNAL = false,
        .HAVE_SIMD128_EXTERNAL = have_wasm_feat(t, .simd128),
        .HAVE_AESNI_EXTERNAL = have_x86_feat(t, .aes),
        .HAVE_CLMUL_EXTERNAL = false,
        ...
        .HAVE_ARM_CRC_INLINE = have_arm_feat(t, .crc) or have_aarch64_feat(t, .crc),
        ...
        .HAVE_SVE_INLINE = have_aarch64_feat(t, .sve),
        .HAVE_SVE2_INLINE = have_aarch64_feat(t, .sve2),
        .HAVE_SME_INLINE = have_aarch64_feat(t, .sme),
        .HAVE_SME_I16I64_INLINE = have_aarch64_feat(t, .sme_i16i64),
        .HAVE_SME2_INLINE = have_aarch64_feat(t, .sme2),
        ...
        .HAVE_VEC_XL_INLINE = false,
        .HAVE_VSX_INLINE = have_ppc_feat(t, .vsx),
        .HAVE_RV_INLINE = false,
        .HAVE_RVV_INLINE = false,
        .HAVE_RV_ZICBOP_INLINE = false,
        .HAVE_RV_ZVBB_INLINE = false,
        .HAVE_SIMD128_INLINE = have_wasm_feat(t, .simd128),
        .HAVE_AESNI_INLINE = have_x86_feat(t, .aes),
        .HAVE_CLMUL_INLINE = false,
        ...
        .HAVE_VIRTUALALLOC = t.os.tag == .windows,
        ...
        .HAVE_AS_ARCHEXT_SVE_DIRECTIVE = t.cpu.arch == .aarch64,
        .HAVE_AS_ARCHEXT_SVE2_DIRECTIVE = t.cpu.arch == .aarch64,
        .HAVE_AS_ARCHEXT_SME_DIRECTIVE = t.cpu.arch == .aarch64,
        .HAVE_AS_ARCHEXT_SME_I16I64_DIRECTIVE = t.cpu.arch == .aarch64,
        .HAVE_AS_ARCHEXT_SME2_DIRECTIVE = t.cpu.arch == .aarch64,
        ...
        .HAVE_KCMVIDEOCODECTYPE_AV1 = false,
        ...
        .HAVE_KCVPIXELFORMATTYPE_422YPCBCR8_YUVS = false,
        ...
        .HAVE_STRUCT_MFXCONFIGINTERFACE = false,
        .HAVE_GZIP = true,
        .HAVE_IOCTL_POSIX = false,
        ...
        .CONFIG_LIBOAPV = false,
        .CONFIG_LIBOPENCV = false,
        .CONFIG_LIBOPENCOLORIO = false,
        ...
        .CONFIG_LIBVPX = false,
        .CONFIG_LIBVVENC = false,
        .CONFIG_LIBWEBP = false,
        .CONFIG_LIBXEVD = false,
        .CONFIG_LIBXEVDB = false,
        .CONFIG_LIBXEVE = false,
        .CONFIG_LIBXEVEB = false,
        ...
        .CONFIG_CUVID = false,
        .CONFIG_D3D11VA = t.os.tag == .windows,
        .CONFIG_D3D12VA = t.os.tag == .windows,
        .CONFIG_DXVA2 = t.os.tag == .windows,
        ...
        .CONFIG_PIC = pic,
        .CONFIG_SHADER_COMPRESSION = true,
        .CONFIG_RESOURCE_COMPRESSION = true,
        .CONFIG_THUMB = false,
        ...
        .CONFIG_CBS_LCEVC = true,
        .CONFIG_CBS_MPEG2 = true,
        .CONFIG_CBS_VP8 = true,
        .CONFIG_CBS_VP9 = true,
        .CONFIG_CELP_MATH = true,
        .CONFIG_D3D12_INTRA_REFRESH = false,
        .CONFIG_D3D12_MOTION_ESTIMATOR = false,
        .CONFIG_D3D12_VIDEO_PROCESS_REFERENCE_INFO = false,
        .CONFIG_D3D12VA_ENCODE = false,
        .CONFIG_D3D12VA_ME_PRECISION_EIGHTH_PIXEL = false,
        .CONFIG_DEFLATE_WRAPPER = true,
        .CONFIG_DIRAC_PARSE = true,
        .CONFIG_DNN = true,
        .CONFIG_DOVI_RPUDEC = true,
        .CONFIG_DOVI_RPUENC = true,
        ...
        .CONFIG_VULKAN_1_4 = false,
        .CONFIG_VC1DSP = true,
        .CONFIG_VIDEODSP = true,
        .CONFIG_VP3DSP = true,
        .CONFIG_VP8DSP = true,
        .CONFIG_VULKAN_ENCODE = false,
        .CONFIG_VVC_SEI = true,
    ...
    const config_h = b.addConfigHeader(.{
        ...
        .include_guard = "FFMPEG_CONFIG_H",
    }, .{
        .FFMPEG_CONFIGURATION = "",
        .FFMPEG_LICENSE = "LGPL version 2.1 or later",
        .CONFIG_THIS_YEAR = 2026,
    ...
    const config_components_values = .{
        ...
        .CONFIG_LCEVC_METADATA_BSF = true,
        ...
        .CONFIG_SMPTE436M_TO_EIA608_BSF = true,
        ...
        .CONFIG_PRORES_RAW_DECODER = true,
        ...
        .CONFIG_ADPCM_CIRCUS_DECODER = false,
        ...
        .CONFIG_ADPCM_IMA_ESCAPE_DECODER = false,
        .CONFIG_ADPCM_IMA_HVQM2_DECODER = false,
        .CONFIG_ADPCM_IMA_HVQM4_DECODER = false,
        .CONFIG_ADPCM_IMA_ISS_DECODER = true,
        .CONFIG_ADPCM_IMA_MAGIX_DECODER = false,
        .CONFIG_ADPCM_IMA_MOFLEX_DECODER = true,
        .CONFIG_ADPCM_IMA_MTF_DECODER = true,
        .CONFIG_ADPCM_IMA_OKI_DECODER = true,
        .CONFIG_ADPCM_IMA_PDA_DECODER = false,
        ...
        .CONFIG_ADPCM_IMA_XBOX_DECODER = true,
        .CONFIG_ADPCM_MS_DECODER = true,
        .CONFIG_ADPCM_MTAF_DECODER = true,
        .CONFIG_ADPCM_N64_DECODER = false,
        .CONFIG_ADPCM_PSX_DECODER = true,
        .CONFIG_ADPCM_PSXC_DECODER = false,
        .CONFIG_ADPCM_SANYO_DECODER = true,
        ...
        .CONFIG_LIBJXL_ANIM_DECODER = false,
        .CONFIG_LIBJXL_DECODER = false,
        .CONFIG_LIBLC3_DECODER = false,
        .CONFIG_LIBMPEGHDEC_DECODER = false,
        ...
        .CONFIG_LIBSVTJPEGXS_DECODER = false,
        ...
        .CONFIG_AAC_MEDIACODEC_DECODER = false,
        .CONFIG_AMRNB_MEDIACODEC_DECODER = false,
        .CONFIG_AMRWB_MEDIACODEC_DECODER = false,
        ...
        .CONFIG_FFV1_VULKAN_ENCODER = false,
        ...
        .CONFIG_H264_RKMPP_ENCODER = false,
        .CONFIG_HAP_ENCODER = false,
        .CONFIG_HEVC_RKMPP_ENCODER = false,
        ...
        .CONFIG_PRORES_KS_VULKAN_ENCODER = false,
        ...
        .CONFIG_LIBJXL_ANIM_ENCODER = false,
        .CONFIG_LIBJXL_ENCODER = false,
        .CONFIG_LIBLC3_ENCODER = false,
        .CONFIG_LIBMP3LAME_ENCODER = true,
        .CONFIG_LIBOAPV_ENCODER = false,
        ...
        .CONFIG_LIBSVTJPEGXS_ENCODER = false,
        ...
        .CONFIG_AV1_D3D12VA_ENCODER = false,
        ...
        .CONFIG_HEVC_VULKAN_ENCODER = false,
        ...
        .CONFIG_AV1_D3D11VA_HWACCEL = t.os.tag == .windows,
        .CONFIG_AV1_D3D11VA2_HWACCEL = t.os.tag == .windows,
        .CONFIG_AV1_D3D12VA_HWACCEL = t.os.tag == .windows,
        .CONFIG_AV1_DXVA2_HWACCEL = t.os.tag == .windows,
        .CONFIG_AV1_NVDEC_HWACCEL = false,
        .CONFIG_AV1_VAAPI_HWACCEL = false,
        .CONFIG_AV1_VDPAU_HWACCEL = false,
        .CONFIG_AV1_VIDEOTOOLBOX_HWACCEL = false,
        .CONFIG_AV1_VULKAN_HWACCEL = false,
        .CONFIG_DPX_VULKAN_HWACCEL = false,
        .CONFIG_FFV1_VULKAN_HWACCEL = false,
        .CONFIG_H263_VAAPI_HWACCEL = false,
        .CONFIG_H263_VIDEOTOOLBOX_HWACCEL = false,
        .CONFIG_H264_D3D11VA_HWACCEL = t.os.tag == .windows,
        .CONFIG_H264_D3D11VA2_HWACCEL = t.os.tag == .windows,
        .CONFIG_H264_D3D12VA_HWACCEL = t.os.tag == .windows,
        .CONFIG_H264_DXVA2_HWACCEL = t.os.tag == .windows,
        ...
        .CONFIG_HEVC_D3D11VA_HWACCEL = t.os.tag == .windows,
        .CONFIG_HEVC_D3D11VA2_HWACCEL = t.os.tag == .windows,
        .CONFIG_HEVC_D3D12VA_HWACCEL = t.os.tag == .windows,
        .CONFIG_HEVC_DXVA2_HWACCEL = t.os.tag == .windows,
        ...
        .CONFIG_MPEG2_D3D11VA_HWACCEL = t.os.tag == .windows,
        .CONFIG_MPEG2_D3D11VA2_HWACCEL = t.os.tag == .windows,
        .CONFIG_MPEG2_D3D12VA_HWACCEL = t.os.tag == .windows,
        .CONFIG_MPEG2_DXVA2_HWACCEL = t.os.tag == .windows,
        ...
        .CONFIG_PRORES_VULKAN_HWACCEL = false,
        .CONFIG_PRORES_RAW_VULKAN_HWACCEL = false,
        .CONFIG_VC1_D3D11VA_HWACCEL = t.os.tag == .windows,
        .CONFIG_VC1_D3D11VA2_HWACCEL = t.os.tag == .windows,
        .CONFIG_VC1_D3D12VA_HWACCEL = t.os.tag == .windows,
        .CONFIG_VC1_DXVA2_HWACCEL = t.os.tag == .windows,
        ...
        .CONFIG_VP9_D3D11VA_HWACCEL = t.os.tag == .windows,
        .CONFIG_VP9_D3D11VA2_HWACCEL = t.os.tag == .windows,
        .CONFIG_VP9_D3D12VA_HWACCEL = t.os.tag == .windows,
        .CONFIG_VP9_DXVA2_HWACCEL = t.os.tag == .windows,
        ...
        .CONFIG_VP9_VULKAN_HWACCEL = false,
        .CONFIG_VVC_VAAPI_HWACCEL = false,
        .CONFIG_WMV3_D3D11VA_HWACCEL = t.os.tag == .windows,
        .CONFIG_WMV3_D3D11VA2_HWACCEL = t.os.tag == .windows,
        .CONFIG_WMV3_D3D12VA_HWACCEL = t.os.tag == .windows,
        .CONFIG_WMV3_DXVA2_HWACCEL = t.os.tag == .windows,
        ...
        .CONFIG_AHX_PARSER = false,
        .CONFIG_AMR_PARSER = true,
        .CONFIG_APV_PARSER = true,
        ...
        .CONFIG_JPEGXS_PARSER = true,
        .CONFIG_LCEVC_PARSER = true,
        ...
        .CONFIG_PRORES_PARSER = true,
        .CONFIG_PNG_PARSER = true,
        .CONFIG_PNM_PARSER = true,
        .CONFIG_PRORES_RAW_PARSER = true,
        ...
        .CONFIG_V4L2_INDEV = t.os.tag == .linux,
        ...
        .CONFIG_V4L2_OUTDEV = t.os.tag == .linux,
        ...
        .CONFIG_BLACKDETECT_VULKAN_FILTER = false,
        ...
        .CONFIG_COLORDETECT_FILTER = true,
        ...
        .CONFIG_DEINTERLACE_D3D12_FILTER = false,
        ...
        .CONFIG_INTERLACE_VULKAN_FILTER = false,
        ...
        .CONFIG_MESTIMATE_D3D12_FILTER = false,
        ...
        .CONFIG_PREMULTIPLY_DYNAMIC_FILTER = true,
        ...
        .CONFIG_VPP_AMF_FILTER = false,
        .CONFIG_SR_AMF_FILTER = false,
        .CONFIG_SCALE_CUDA_FILTER = false,
        .CONFIG_SCALE_D3D11_FILTER = false,
        .CONFIG_SCALE_D3D12_FILTER = false,
        ...
        .CONFIG_SCDET_VULKAN_FILTER = false,
        ...
        .CONFIG_PAD_VAAPI_FILTER = false,
        .CONFIG_DRAWBOX_VAAPI_FILTER = false,
        .CONFIG_ALLRGB_FILTER = true,
        .CONFIG_ALLYUV_FILTER = true,
        .CONFIG_AMF_CAPTURE_FILTER = false,
        ...
        .CONFIG_GFXCAPTURE_FILTER = false,
        ...
        .CONFIG_IMAGE_JPEGXS_PIPE_DEMUXER = true,
        ...
        .CONFIG_LC3_MUXER = true,
        .CONFIG_LRC_MUXER = true,
        .CONFIG_M4V_MUXER = true,
        .CONFIG_MCC_MUXER = true,
...
fn categorizeSources(ally: std.mem.Allocator, target: std.Target, tls: Tls) CategorizedSources {
    ...
    for (all_sources) |prefixed_path| {
        ...
        } else if (std.mem.startsWith(u8, prefixed_path, "/U/")) p: {
            // poor man's check for unix
            if (target.os.tag == .windows) continue;
            break :p prefixed_path["/U/".len..];
        } else if(std.mem.startsWith(u8, prefixed_path, "/M/")) p: {
            if (target.os.tag != .macos) continue;
            break :p prefixed_path["/M/".len..];
        }  else prefixed_path;
        ...
        if (std.mem.startsWith(u8, sub_path, "tls_")) {
            ...
            continue;
        } else if (isComponentSubdir(sub_path)) {
        ...
        } else if (std.mem.startsWith(u8, sub_path, "wasm/")) {
            switch (target.cpu.arch) {
                .wasm32, .wasm64 => {},
                else => continue,
            }
...
fn isComponentSubdir(sub_path: []const u8) bool {
    for (component_subdirs) |component_prefix| {
        if (std.mem.startsWith(u8, sub_path, component_prefix))
            return true;
    }
    return false;
}
...
fn have_wasm_feat(t: std.Target, feat: std.Target.wasm.Feature) bool {
    return switch (t.cpu.arch) {
        .wasm32,
        .wasm64,
        => std.Target.wasm.featureSetHas(t.cpu.features, feat),
        else => false,
    };
}
...
const all_sources = [_][]const u8{
    ...
    "libavcodec/dxtory.c",
    "libavcodec/dxv.c",
    "/W/libavcodec/dxva2.c",
    "/W/libavcodec/dxva2_av1.c",
    "/W/libavcodec/dxva2_h264.c",
    "/W/libavcodec/dxva2_hevc.c",
    "/W/libavcodec/dxva2_mpeg2.c",
    "/W/libavcodec/dxva2_vc1.c",
    "/W/libavcodec/dxva2_vp9.c",
    "libavcodec/dxvenc.c",
    ...
    "libavcodec/riscv/llvidencdsp_rvb.S",
    ...
    "libavcodec/riscv/vvc/sad_rvv.S",
    "libavcodec/rka.c",
    ...
    "/W/libavfilter/vf_deinterlace_d3d12.c",
    ...
    "/W/libavfilter/vf_mestimate_d3d12.c",
    ...
    "/W/libavfilter/vf_scale_d3d11.c",
    "/W/libavfilter/vf_scale_d3d12.c",
    ...
    "/W/libavutil/hwcontext_d3d11va.c",
    "/W/libavutil/hwcontext_d3d12va.c",
    //"libavutil/hwcontext_drm.c",
    "/W/libavutil/hwcontext_dxva2.c",
